...
mongoose.connect('mongodb+srv://juliopm142:juliopm142142@cluster0.xzwh9.mongodb.net/').then(()=>console.log('database connected successfully')).catch(e=>console.log(e))
